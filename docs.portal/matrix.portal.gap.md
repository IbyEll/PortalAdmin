...
| P2 | audit-prio-r7 | Non più rilevato nel codice attivo (PARKING/docs esclusi). | — | fatto |
...
| P1 | bug-tree-regenerate | Non più rilevato nel codice attivo (PARKING/docs esclusi). | — | fatto |
...
| P2 | CI job AdminDashBoard + smoke admin:home | Job smoke-admin-overlay in portal-smoke.yml con test:home su :3990. · Ticket chiuso su Jira. | .github/workflows/portal-smoke.yml, test.smoke/smoke-home.mjs | fatto |
...
| P2 | R6 — CI AdminDashBoard + HOME | Job smoke-admin-overlay in portal-smoke.yml con test:home su :3990. · Ticket chiuso su Jira. | .github/workflows/portal-smoke.yml, test.smoke/smoke-home.mjs | fatto |
