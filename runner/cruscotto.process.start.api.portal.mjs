 ...
 *
 * Uso:
 *   node runner/cruscotto.process.start.api.portal.mjs
 *   node runner/cruscotto.process.start.api.portal.mjs --help
 *
 * Env:
...
import { portalRoot, root } from "../lib/cruscotto-db/script_seed/script_seed-lib.mjs";

const args = process.argv.slice(2);

if (args.includes("--help") || args.includes("-h")) {
  console.log(`Uso: node runner/cruscotto.process.start.api.portal.mjs
