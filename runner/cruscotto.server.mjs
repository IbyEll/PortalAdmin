 ...
 *
 * Dipendenze:
 *   - lib/test.catalog.mjs, dashboard.project.mjs, test.dipendenze.mjs
...
import { getHealthStatus } from "../server/health.mjs";
...
import { getRunStatus, isRunActive, startRun, startRunFunzionali } from "../server/run-manager.mjs";
import {
