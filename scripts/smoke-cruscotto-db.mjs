...
} from "../lib/cruscotto-db/index.mjs";
import { loadJiraBacklogFromDb } from "../lib/cruscotto-db/load-backlog.mjs";
...
try {
  prepareCruscottoDatabaseUrl();
  execFileSync(process.execPath, ["lib/cruscotto-db/migrate.mjs"], {
    cwd   : ROOT
  , stdio : "inherit"
