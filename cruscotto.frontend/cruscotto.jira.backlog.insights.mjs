 ...
 *
 *   Perché esiste:
 *   - il backlog cruscotto deve segnalare disallineamenti tra stato Jira e implementazione nel repo
 *   - centralizza inspect segnali REPO_IMPLEMENTATION_SIGNALS e correlazioni epic/sprint
 *
 *   A cosa serve:
 *   - snapshot insight (ok, warning, suggestion) per pagina backlog e API /api/jira/backlog/insights
 ...
 *   - issues — righe backlog da fetchJiraBacklog o consumer
 *   - repoRefs — scanRepoJiraReferences sul product repo (REPO_ROOT)
 ...
 *   - buildBacklogInsights, buildInsightSnapshot, inspectRepoSignal — core insight
 *   - buildRepoAlignMap, resolveRepoAlignStatus — allineamento repo vs Jira done
 *   - JIRA_PROJECT_KEYS, REPO_IMPLEMENTATION_SIGNALS — re-export overlay
 */
