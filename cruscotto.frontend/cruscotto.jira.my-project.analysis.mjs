...
import { discoverTestScripts, REPO_ROOT, BLOCKED_SCRIPTS, BLOCKED_REASONS } from "../cruscotto.lib/test.catalog.mjs";
...
/**
 * @param {import("../cruscotto.lib/test.catalog.mjs").ScriptEntry[]} testScripts
 */
function scanRepoCapabilities(testScripts) {
  ...
  if (repoExists("cruscotto.frontend/cruscotto.jira.my-project.analysis.mjs")) {
