 ...
 *
 * Usata dagli entrypoint CLI in questa cartella e da Utility/cruscotto (path SQLite,
...
import { getProjectConfig, getProjectHealthUrls, resolveProductSeedPath } from "../../admin/config.project.mjs";
