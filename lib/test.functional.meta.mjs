 ...
 *
 * ************************************************************************************************************************
 *     Meta test funzionali — implementation generica e discovery suite funzionali.
 * ************************************************************************************************************************
 *
 * Descrizione funzionale:
 *
 *   Perché esiste:
 *   - Ogni PROJECT overlay può esporre meta funzionali senza duplicare payload API cruscotto.
 *
 *   A cosa serve:
 *   - FUNZIONALI_IMPLEMENTATION minimale e getFunzionaliMetaPayload per tab TestFunzionali.
 *
 * Generalizzazione:
 *   Si — discovery da test.catalog e test.dipendenze; overlay estende in test.functional.meta.
 *
 * Input:
 *   - PRJ_NAME, PRJ_TEST_SCRIPT — da project.config overlay attivo
 *
 * Consumatori:
 *   - lib/dashboard.project.mjs — fallback se manca test.functional.meta.{Nome}.mjs
 *   - PROJECT overlay test.functional.meta.{Nome}.mjs — scenari custom
 *
 * Export principali:
 *   - FUNZIONALI_IMPLEMENTATION — overview tab funzionali default
 *   - buildFunzionaliMetaPayload, getFunzionaliMetaPayload — payload API cruscotto
 *
 * ------------------------------------------------------------------------------------------------------------------------
 */
