 ...
 *
 *   Perché esiste:
 *   - Ogni PROJECT overlay può esporre meta tecnici senza duplicare discovery e parse test case.
 *
 *   A cosa serve:
 *   - TECNICI_IMPLEMENTATION minimale e getTecniciMetaPayload per tab TestTecnici cruscotto.
 *
 * Generalizzazione:
 *   Si — discovery da test.catalog; overlay estende prerequisites in test.technical.meta.
 *
 * Input:
 ...
 *   - PROJECT overlay test.technical.meta — re-export opzionale
 *
 * Export principali:
 *   - TECNICI_IMPLEMENTATION — overview tab tecnici default
 *   - getTecniciMetaPayload, buildTecniciMetaPayload — payload API cruscotto
 *
 * ------------------------------------------------------------------------------------------------------------------------
 */
