 ...
 *     Process e match processi nel cruscotto dev.
 *
 ...
 *
 * Env: PRJ_NAME → discovery.config.{name}.mjs
 */

import { getProjectConfig, resolveProjectOverlayName } from "./project.config.mjs";

/**
 * Nome file overlay `discovery.config.{name}.mjs`.
 *
 * @returns {string}
 */
...
// 1. Carica overlay product — stesso PRJ_NAME di project.config / runner.config.stack
