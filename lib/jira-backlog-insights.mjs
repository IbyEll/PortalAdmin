...
import { isMeaningfulCitationPath } from "./repo-implementation-signals-catalog.mjs";
import { scanRepoJiraReferences, truncateIssueSummary } from "./repo-jira-refs.mjs";
...
/**
 * Segnali path noti (opzionale) — estende la scansione citazioni JLO su tutta la backlog.
 *
 * @type {Array<{ key: string, label: string, paths: string[], tests?: string[] }>}
 */
