...
export function analyzeRepository(portalRoot) {
  ...
  const workingData = existsSync(join(portalRoot, "PROJECT_JustLastOne/working.plan.data.JustLastOne.mjs"));
  ...
  , workingPlanDataPresent: {
      ok     : workingData
    , label  : "working.plan.data.JustLastOne.mjs"
    , detail : workingData
        ? "File dati piano JLO presente"
        : "File assente — import in working.order / working.plan.overlay rotti"
    }
