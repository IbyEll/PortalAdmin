 ...
 * Non usa jira.backlog.insights né jira.working.insights.
 */
...
import { discoverTestScripts, REPO_ROOT, BLOCKED_SCRIPTS, BLOCKED_REASONS } from "./prj_testScript_catalog.mjs";
...
import { scanRepoJiraReferences, walkRepoTextFiles } from "../function.repo.jira.refs.mjs";
import { LATEST_JSON, computeTestCountsBySuite, normalizeReport } from "../reporter.mjs";
...
/**
 * @param {import("./prj_testScript_catalog.mjs").ScriptEntry[]} testScripts
 */
