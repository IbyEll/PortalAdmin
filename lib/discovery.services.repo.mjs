 ...
 *     friendbot, dashboard, api-documentation) senza hardcodare porte, script e cwd ovunque.
 ...
 *     — ADMIN: dev-manifest PRJ_DEV_MANIFEST, runner (cruscotto.process.start.all.services, API Documentation),
