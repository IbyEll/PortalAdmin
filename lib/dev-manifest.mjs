 ...
 *     requirements + services per API dev, smoke test e repo-service-discovery.
 *
 ...
 *
 * Consumatori: server/dev-api.mjs, lib/repo-service-discovery.mjs,
...
import { getProjectConfig } from "./config.project.mjs";
