 ...
 *
 *   Perché esiste:
 *   - Cruscotto, dev-api e discovery devono condividere porte, health URL e comandi start senza
 *     duplicare JSON in ogni consumer.
 *
 *   A cosa serve:
 *   - Legge e cachea manifest PortalAdmin (PRJ_PRODUCT_MANIFEST); valida requirements e services.
 *
 * Generalizzazione:
 *   Si — path manifest da PRJ_PRODUCT_MANIFEST in project.config overlay.
 *
 * Input:
 *   - PRJ_PRODUCT_MANIFEST — path relativo root PortalAdmin al JSON manifest
 *
 * Consumatori:
 ...
 *   - invalidateProductManifestCache — reset cache per test o reload overlay
