 ...
 *
 * ************************************************************************************************************************
 *              Report test run-all — normalizzazione JSON, HTML e merge latest.json.
 * ************************************************************************************************************************
 *
 * Descrizione funzionale:
 *
 *   Perché esiste:
 *   - Run-all e dashboard devono persistere esiti suite in formato uniforme per UI e analisi.
 *
 *   A cosa serve:
 *   - Parse stdout JSON, normalizza struttura script/test, genera HTML e merge incrementale.
 *
 * Generalizzazione:
 *   Si — path report sotto cruscotto.frontend/reports indipendente da overlay product.
 *
 * Input:
 *   - raw report object — payload da run-all o singolo script
 ...
 *
 * Export principali:
 *   - normalizeReport, computeSummary — struttura NormalizedRunReport
 *   - generateHtml, writeRunReports — persistenza latest e history
 *   - mergeWithLatestReport — merge run parziale su latest esistente
 *   - parseScriptJsonReport — estrae JSON da stdout child
 *
 * ------------------------------------------------------------------------------------------------------------------------
 */
...
/**
 * Directory report in PortalAdmin (`cruscotto.frontend/reports/`) — non nel product repo.
 *
 * @returns {string}
 */
...
<head>
  ...
  <title>${escapeHtml(getProjectConfig().PRJ_NAME)} — Test report</title>
  <style>
    :root {
