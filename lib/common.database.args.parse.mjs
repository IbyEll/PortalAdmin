 ...
 *
 *   Perché esiste:
 *   - Flag --seed, --push e --reset condivisi senza import circolari verso runner stack.
 *
 *   A cosa serve:
 *   - Estrae id seed e booleani dev DB da argv per entrypoint prepare e seed.
 *
 * Generalizzazione:
 *   Si — parser argv puro riusabile da runner e cruscotto.database senza overlay.
 *
 * Input:
 *   - argv process.argv slice — flag CLI --seed, --reset, --help, --push
 *
 * Consumatori:
 *   - cruscotto.frontend/cruscotto.runner.stack.mjs — parseSeedIds in prepare stack
 *   - cruscotto.database/script_seed/script_seed-lib.mjs — init_Database_DEV e run-data-seeds
 *
 * Export principali:
 *   - parseSeedIds — id seed da --seed, --seed-db, --seed-func e alias
 *   - parseDbDevArgs — help, reset, seed e pushOnly per init database dev
 *
 * ------------------------------------------------------------------------------------------------------------------------
 */
