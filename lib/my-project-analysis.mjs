...
import { discoverTestScripts, REPO_ROOT, BLOCKED_SCRIPTS, BLOCKED_REASONS } from "./catalog.mjs";
...
import { scanRepoJiraReferences, walkRepoTextFiles } from "./repo-jira-refs.mjs";
...
/**
 * @param {import("./catalog.mjs").ScriptEntry[]} testScripts
 */
