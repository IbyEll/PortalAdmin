/**
 * Cruscotto Dev — SPA vanilla (sidebar + hash routing).
 *
 ...
 *
 * Route / asset (serviti da cruscotto.server.mjs):
 ...
 *
 * Consumatori: cruscotto/index.html (`<script src="cruscotto.js">`), cruscotto.home.html
 *
 * Dipendenze: fetch verso stesso origin del cruscotto; hash `#overview` … `#process`
 */

// --- router — tab, hash e meta pagina ---
const TABS = ["overview", "requisiti", "servizi", "test", "summary", "testtecnici", "testfunzionali", "jiraworking", "jiraworkingold", "jiraproject", "backlog", "myproject", "pillarmatrix", "process"];
...
async function renderProcess(report) {
  ...
  root.innerHTML = `
        ...
        <table class="data process-intro-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <code>node runner/cruscotto.process.start.all.services.mjs</code>
            ...
            <tr>
              ...
              <td>
                ...
                <code>node runner/cruscotto.process.start.api.portal.mjs</code>
        ...
        <table class="data process-intro-table">
          ...
          <tbody>
            <tr>
              ...
              <td><code>node runner/cruscotto.process.start.all.services.mjs</code></td>
            </tr>
            <tr>
              <td><strong>Avvia stack completo</strong></td>
              <td><code>node runner/cruscotto.process.start.all.services.mjs</code> + friendBOT + API Portal</td>
            </tr>
            <tr>
              <td><strong>Kill All</strong></td>
              <td><code>node runner/cruscotto.process.stop.all.services.mjs</code> o <code>npm run stop:all</code>
    ...
    <div class="panel">
      ...
      <p class="muted process-stop-hint">Kill All: libera 3000, 4000, 4001, 4080 e termina friendBOT JLO — output nella console. Il cruscotto :3999 resta attivo.</p>
      ...
      <div class="cmd-block" style="margin-top:0.75rem">
        ...
        <code id="process-cli-cmd">node runner/cruscotto.process.start.all.services.mjs</code>
...
async function hydrateProcessStack(root) {
    ...
    return `
      <tr${processTrClassAttr(PROCESS_BLOCK_DB_FILE, "process-db-row", "process-db-file-row")}>
        ...
        <td class="process-actions-cell">
          <div class="process-actions-stack">
            <button type="button" class="action process-action-btn" data-process-action="db-reset" title="Elimina JLO_DEV.db e ricrea schema">Delete &amp; create</button>
          </div>
        </td>
      </tr>
  ...
  async function loadProcessDiscovery(triggerBtn = null, options = {}) {
    ...
    try {
      ...
      if (!processesOnly) {
        cliEl.textContent  = `node runner/cruscotto.process.start.all.services.mjs`;
