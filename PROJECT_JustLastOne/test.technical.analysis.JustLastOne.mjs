/**
 * ------------------------------------------------------------------------------------------------------------------------
 * ** TEST ANALYSIS ** -- commentato il: 2026-06-18 12:10
 * ------------------------------------------------------------------------------------------------------------------------
 * creato     il: 2026-06-18 12:10   by: IbyEll
 * modificato il: 2026-06-18 12:10   by: IbyEll
 * ------------------------------------------------------------------------------------------------------------------------
 *
 * ************************************************************************************************************************
 *      Analisi TestTecnici JustLastOne — entry overlay su lib/test.technical.analysis.mjs
 * ************************************************************************************************************************
 *
 ...
 *     per GET/POST analisi TestTecnici del cruscotto JustLastOne.
 *
 * Generalizzazione:
 ...
 *
 * Input:
 *   - PRJ_NAME=JustLastOne — seleziona questo file via lib/dashboard.project.mjs
