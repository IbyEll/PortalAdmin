...
function scanRepoCapabilities(testScripts) {
  ...
  if (repoExists("lib/JustLastOne___my-project-analysis.mjs")) {
...
export async function analyzeMyProject() {
  ...
  // 2. Aggregati Jira — status, tipo, story aperte, gap ref repo
  ...
  // 4. Assembly sezioni ordinate (progress → sprint → backlog embed → sintesi → gap)
